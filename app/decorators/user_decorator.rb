class UserDecorator < Draper::Decorator
  ...
  def public_hash
    attrs = %w(username display_name current_location number_of_tweets number_of_mentions room_number real_name home_location vcard_public?)
  ...
  def admin_hash
    return_attribute_hash %w(username is_admin status email email_public?  vcard_public? display_name current_location last_login empty_password? room_number real_name home_location)
  end
